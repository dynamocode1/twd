...
from .views import Home,Register,Courses,CoursesSearch,LearnCourse,About,Blogs,ReadBlog,Login,ForgotPassword
...
path('courses/<uuid:id>',LearnCourse.as_view(),name = 'course'),
path('about',About.as_view(),name = 'about'),
path('blogs',Blogs.as_view(),name = 'blogs'),
path('blogs/read_more/<uuid:pk>',ReadBlog.as_view(),name = 'read_blog'),
...
path('cp/admin/courses/view/<uuid:course_id>',ViewCourse.as_view(),name = 'view_course'),
...
path('cp/admin/courses/edit/<uuid:id>',EditCourse.as_view(),name = 'edit_course'),
path('cp/admin/courses/delete/<uuid:id>',delete_course,name = 'delete_course'),
path('cp/admin/blogs/new',NewBlog.as_view(),name = 'new_blog'),
path('cp/admin/blogs/all',AllBlog.as_view(),name = 'all_blog'),
path('cp/admin/blogs/delete/<uuid:id>',delete_blog,name = 'delete_blog'),
path('cp/admin/blogs/edit/<uuid:id>',EditBlog.as_view() ,name = 'edit_blog'),
path('cp/admin/courses/pub/<uuid:id>',PubCourse,name = 'pub'),
